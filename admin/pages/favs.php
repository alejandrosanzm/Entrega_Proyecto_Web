	...
	<div class="col-md-12">
		<div class="grid email">
			<div class="grid-body">
                ...
                <li class="active"><a href="favs.php"><i class="fa fa-thumbs-up"></i> Favoritas</a></li>
                ...
                <!-- Si no hay foto, td de imagen vacío y td anterior (de subject) con colspan a 2 -->
                  ...
                  ?>
                  <tr><td colspan="7" style="background-color:#f6f6f6;"><i class="fa fa-thumbs-up">&nbsp;&nbsp;</i>Mis cartas favoritas</td></tr>
