		...
		<div class="grid email">
			<div class="grid-body">
                ...
                <li><a href="favs.php"><i class="fa fa-thumbs-up"></i> Favoritas</a></li>
								...
								<li class="active"><a href="profiles.php"><i class="fa fa-users"></i> Perfiles</a></li>
                ...
                <select class="btn btn-default dropdown-toggle" name="action" onchange="this.form.submit()">
                  ...
                  <option value="filter">Filtrar por estos perfiles</option>
                  <option value="filterwo">Filtrar descartando estos perfiles</option>
                </select>
							</div>
                ...
                <!-- Si no hay foto, td de imagen vacío y td anterior (de subject) con colspan a 2 -->
                  ...
                  ?>
                  <tr><td colspan="7" style="background-color:#f6f6f6;"><i class="fa fa-users">&nbsp;&nbsp;</i>Perfiles disponibles</td></tr>
                  <?php require '../engine/profiles.php'; ?>
							</tbody></table>
						</div>
						</ul> -->
					</div>
